...
StormtropperDAO.prototype.find = function (data, callback) {
  this.model.find(query).exec(callback);
};

StormtropperDAO.prototype.findOne = function (_id, data, callback) {
  var query = {_id: _id };
...
StormtropperDAO.prototype.remove = function (_id, data, callback) {
  var query = {_id: _id };
